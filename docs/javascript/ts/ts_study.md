...
![](https://pic3.zhimg.com/v2-79fb26564005ac9e6df7c5eff07d56fe_b.jpg)

![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1304' height='546'></svg>)

### **字符串枚举**

字符串枚举要注意的是必须要有**默认值**，不支持**反向映射**

![](https://pic1.zhimg.com/v2-cf4405b954ecc1e13c3eb417c47de3f4_b.jpg)

![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1304' height='481'></svg>)

### **常量枚举**

除了`数字类型`和`字符串类型`之外，还有一种特殊的类型，那就是**常量枚组**，也就是通过`const`去定义`enum`，但这种类型不会编译成任何 `JS`,只会编译对应的值

![](https://pic2.zhimg.com/v2-65ea112430ee5bd10a441de8cc7273dd_b.jpg)

![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1304' height='352'></svg>)

### **异构枚举**

包含了 `数字类型` 和 `字符串类型` 的混合，反向映射一样的道理  

![](https://pic3.zhimg.com/v2-b92e4f2b3cdbd9ea0751de64df1e6132_b.jpg)

![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1304' height='657'></svg>)
...
**typeof关键字**：我们在类型保护的时候讲解了typeof的作用，除此之外，这个关键字还可以实现**推出类型**，如下图，可以推断中 **Props 包含的类型**

![](https://pic2.zhimg.com/v2-de79b5dd47ee8f16bbae8cb87f053b11_b.jpg)

![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='700' height='456'></svg>)

### keyof

**keyof关键字**: 可以获取一个对象接口的所有`key`值,可以检查对象上的键是否存在
...
![](https://pic4.zhimg.com/v2-24f21072a9928b93da9e4be83dbdbb5f_b.jpg)

![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='486' height='334'></svg>)

### in

**in**：映射类型, 用来映射遍历枚举类型

![](https://pic1.zhimg.com/v2-af7436930177ec67ba1cb0ac13353994_b.jpg)

![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='616' height='398'></svg>)
...
**Required语法**：`Required<T>` 作用：将所有属性变为必选的，与 `Partial`相反
...
![](https://pic1.zhimg.com/v2-4bbe230167052cc2c2790c813e1e3268_b.jpg)

![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='686' height='428'></svg>)
...
![](https://pic3.zhimg.com/v2-85487144a22a36e56fbd95280aa8f93a_b.jpg)

![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='964' height='164'></svg>)
